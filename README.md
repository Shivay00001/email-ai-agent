...
An automated Cold Email Outreach AI agent powered by SendGrid to autonomously draft, review, and send customized emails.

## Overview
This repository contains a full-stack implementation of the **AI Email Outreach Agent**. 
